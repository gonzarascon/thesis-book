...
const Layout = ({ children, title = 'This is the default title' }: Props) => (
  <div className="flex flex-col min-h-screen">
    ...
    <header className="sticky top-0 left-0 z-20 flex items-center justify-center w-full px-4 py-6 mx-auto bg-white sm:py-12 bg-opacity-30 backdrop-filter backdrop-blur-md">
